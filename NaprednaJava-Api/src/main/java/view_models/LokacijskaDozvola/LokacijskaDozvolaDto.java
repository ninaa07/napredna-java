...
public class LokacijskaDozvolaDto {
    ...
    public LokacijskaDozvolaDto() {
    }

    public LokacijskaDozvolaDto(@JsonProperty("id") Integer id, @JsonProperty("naziv") String naziv, @JsonProperty("opstiPodaci") String opstiPodaci, @JsonProperty("lokacijskiUslovi") String lokacijskiUslovi, @JsonProperty("brojParcele") Long brojParcele, @JsonProperty("povrsinaParcele") Long povrsinaParcele, @JsonProperty("nazivIdejnogResenja") String nazivIdejnogResenja, @JsonProperty("datumIzdavanja") Date datumIzdavanja, @JsonProperty("informacijeOLokacijiId") Integer informacijeOLokacijiId) {
        this.id = id;
        this.naziv = naziv;
