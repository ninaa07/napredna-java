...
public class UpdateProjekatZaGradjevinskuDozvoluDto {
    ...
    public UpdateProjekatZaGradjevinskuDozvoluDto(@JsonProperty("id") Integer id, @JsonProperty("naziv") String naziv, @JsonProperty("datumIzrade") Date datumIzrade, @JsonProperty("nazivIdejnogResenja") String nazivIdejnogResenja, @JsonProperty("statusDokumenta") StatusDokumenta statusDokumenta, @JsonProperty("idejnoResenjeId") Integer idejnoResenjeId) {
        this.id = id;
        this.naziv = naziv;
