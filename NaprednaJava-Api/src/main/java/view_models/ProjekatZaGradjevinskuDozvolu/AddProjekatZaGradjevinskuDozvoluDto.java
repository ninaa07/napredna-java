...
public class AddProjekatZaGradjevinskuDozvoluDto {
    ...
    public AddProjekatZaGradjevinskuDozvoluDto(@JsonProperty("naziv") String naziv, @JsonProperty("datumIzrade") Date datumIzrade, @JsonProperty("nazivIdejnogResenja") String nazivIdejnogResenja, @JsonProperty("statusDokumenta") StatusDokumenta statusDokumenta, @JsonProperty("idejnoResenjeId") Integer idejnoResenjeId) {
        this.naziv = naziv;
